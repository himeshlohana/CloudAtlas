    ...
    <section className="achieve-goals">
      ...
      <div className="achieve-content">
        <div className="achieve-item">
          ...
          <p>Our industry expert trainers deliver cutting-edge IT training with hands-on, tailored instruction to ensure practical skill development and deep understanding.</p>
        </div>
        <div className="achieve-item">
          <h3>Life Time Support</h3>
          <p>We offer lifetime support, providing ongoing assistance and resources to ensure your continuous growth and success in the IT field.</p>
        </div>
        <div className="achieve-item">
          <h3>Flexible Batches</h3>
          <p>We offer flexible batch schedules to fit your availability, ensuring convenient and personalized learning experiences.</p>
        </div>
        <div className="achieve-item">
          <h3>Interview Preparation</h3>
          <p>We provide comprehensive interview preparation, equipping you with the skills and confidence needed to excel in your IT job interviews.</p>
        </div>
        <div className="achieve-item">
          <h3>100% Placement Assistance</h3>
          <p>After completion of training, we provide Job Assistance, Scheduled Unlimited Interviews for every student.</p>
        </div>
        <div className="achieve-item">
          <h3>Live Projects</h3>
          <p>The course includes a live project, providing hands-on experience with real-world applications. Students collaborate to solve practical problems, integrating theoretical knowledge with practical skills.</p>
        </div>
      </div>
    </section>
  </div>
